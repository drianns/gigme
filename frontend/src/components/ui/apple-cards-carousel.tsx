    ...
    return (
        ...
        >
            <div className="relative w-full">
                ...
                >
                    <div className="absolute right-0 z-[1000] h-auto w-[5%] overflow-hidden bg-gradient-to-l from-gray-50 to-transparent"></div>
                ...
                <div className="flex justify-end gap-2 mr-10">
                    ...
                    >
                        <FiChevronLeft className="h-6 w-6 text-gray-500" />
                    </button>
                    <button
                        className="relative z-40 h-10 w-10 rounded-full bg-gray-100 flex items-center justify-center disabled:opacity-50 hover:bg-gray-200 transition-colors"
                        onClick={scrollRight}
                    ...
                    <div className="fixed inset-0 h-screen z-50 overflow-auto">
                        ...
                        >
                            <button
                                ...
                                onClick={handleClose}
                            >
                                <FiX className="h-5 w-5 text-white dark:text-black" />
                            </button>
                            <motion.p
